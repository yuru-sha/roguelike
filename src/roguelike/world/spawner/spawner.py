...
from roguelike.world.entity.components.base import AI, Fighter, Item, Position
...
def get_random_choice_from_chances(chances_dict: dict, dungeon_level: int) -> Any:
    ...
    valid_choices = [
        ...
        if data.get("min_level", 0) <= dungeon_level
        and (data.get("max_level") is None or dungeon_level <= data.get("max_level"))
    ]
