...
from roguelike.world.entity.components.base import (Item, Position, Renderable,
                                                    RenderOrder)
...
def create_food_ration(world: Any, x: int, y: int) -> int:
    ...
    world.add_component(food, Item(name="Food Ration", use_function=use_food_ration))
