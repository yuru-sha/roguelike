...
from roguelike.world.entity.components import Item, Inventory, Equipment, Equippable, Fighter, Position
...
class InventorySystem:
    ...
    def remove_item(self, owner: int, item: int) -> bool:
        """アイテムを捨てる"""
        if not self.world.has_component(owner, Inventory):
            return False
    ...
    def use_item(self, owner: int, item: int, target: Optional[int] = None) -> bool:
        ...
        item_component.use_function(self.world, owner, **kwargs)
